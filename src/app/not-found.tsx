...
export default function NotFound() {
  return (
    <div className="h-screen flex flex-col font-sans overflow-hidden">
      <Navbar />
      <main className="flex-1 flex items-center justify-center bg-[#f8fafc] p-8 overflow-y-auto">
        <div className="max-w-lg w-full bg-white border-t-8 border-journal-navy shadow-2xl p-12 text-center">
          ...
          <p className="text-sm text-slate-500 leading-relaxed mb-8 italic">
            The page you requested could not be located in the JIESURT publication system. Please verify the URL or navigate using the links below.
          </p>
